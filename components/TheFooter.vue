<template>
  <footer class="bg-background">
    <div class="px-6">
      <div
        class="container mx-auto bg-background-light flex flex-col space-y-4 shadow-xl -mb-28 max-w-7xl py-10 px-8 z-10 relative lg:flex-row lg:space-y-0 lg:-mb-12 lg:justify-between"
      >
    ...
    <div class="bg-[#1C1C1C] w-full px-8 pt-24 pb-8 lg:pt-16 lg:pb-4">
      ...
      >
        ...
        <div class="space-y-4 my-8">
          <h3
            class="font-subheading text-xl text-primary tracking-widest uppercase"
          >
            Quick Links
          </h3>
          <ul
        ...
        <div class="space-y-6 my-8 lg:space-y-4">
          ...
          <div class="flex flex-row mx-auto max-w-40 justify-between">
            ...
            <div class="text-primary text-3xl i-zmdi-twitter" />
            <div class="text-primary text-3xl i-zmdi-instagram" />
          </div>
        </div>
      </div>
    </div>

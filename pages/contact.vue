<template>
  <div>
    ...
    <section class="bg-background -mt-12 px-6 pb-12 md:-mt-16 md:pb-16">
      <div class="container mx-auto bg-white shadow-xl z-10 relative">
        <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
          ...
          >
            ...
            <div>
              <label
                for="email"
                class="font-body text-sm text-warm-gray-900 block"
                >Email</label
              >
              <div class="mt-1">
                <input
    ...
    <section class="bg-background mt-16 px-6">
      <div
        class="container mx-auto bg-white space-y-10 shadow-xl mb-16 py-20 px-12"
      >
        ...
        >
          <div
            class="md:col-span-5 md:col-start-2 md:row-start-1 mb-12 md:mb-0"
          >
            <a
              href="mailto:info@luxuryrideservice.com"
              class="text-xl tracking-wide"
            >
              <div class="mx-auto mb-8 i-carbon-email text-body text-9xl" />
              info@luxuryrideservice.com</a
            >
          </div>
          <div class="col-span-4 col-start-7 row-start-1">
            <a href="tel:2894009408" class="text-xl tracking-wide">
              <div
                class="mx-auto text-center text-9xl text-body mb-6 i-carbon-phone"
              />
              289.400.9408</a
            >
          </div>
